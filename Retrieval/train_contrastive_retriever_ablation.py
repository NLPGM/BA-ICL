...
if __name__ == '__main__':
    ...
    if len(formatted_train_samples)==0:
        trained_ED_contrastive_retriever = ED_contrastive_retriever
    else:
    ...
    if args.supervisor_ablation_mode=="None":
        ...
        torch.save({'model_state_dict': trained_ED_contrastive_retriever.state_dict()},
                   os.path.join(ckpt_dir, f'{args.supervisor_ablation_mode}_ed_contrastive_retriever.ckpt'))